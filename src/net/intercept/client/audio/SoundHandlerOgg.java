...
import static net.intercept.client.color.ANSI.CLEAR_LINE;
import static net.intercept.client.color.ANSI.GREEN;
import static net.intercept.client.color.ANSI.RESET;
import static net.intercept.client.color.ANSI.RESET_CURSOR;
import static net.intercept.client.color.ANSI.YELLOW;
